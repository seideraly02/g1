...
<template>
  <section class="screen-page bg-[#f8f8f8]">
    ...
    <div class="screen-content space-y-2.5 pt-2 xl:grid xl:grid-cols-12 xl:gap-4 xl:space-y-0">
      <SampleDataNotice class="xl:col-span-12" />
      <button
        class="card block w-full p-4 text-left transition-transform active:scale-[.995] xl:col-span-4"
        type="button"
      ...
      <div class="card p-4 xl:col-span-8">
        <div class="flex items-center justify-between">
      ...
      <div class="card p-4 xl:col-span-12">
        <div class="flex items-center justify-between">
