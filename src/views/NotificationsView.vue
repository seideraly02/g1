...
import { MoonStar, RotateCcw, Target, TrendingUp, Trophy } from 'lucide-vue-next'
...
<template>
  <section class="screen-page bg-[#f8f8f8]">
    ...
    <div class="screen-content pt-3">
      <SampleDataNotice
        class="mb-3"
        text="Төмендегі хабарландырулар — интерфейс үлгісі. Олар жеке жоспарыңнан алынбаған."
      />
      <div class="flex items-center gap-3 py-1">
        <span class="section-label">БҮГІН</span>
        <span class="h-px flex-1 bg-[#dce4ef]" />
        <button
          class="min-h-11 border-0 bg-transparent px-1 text-[11px] font-[850] text-[#1f66d9] disabled:text-[#98a6b9]"
          type="button"
          :disabled="!hasUnread"
          @click="markAllRead"
        >
      ...
      >
        ...
        <span
          v-if="item.unread"
          class="mt-1 size-2 rounded-full bg-[#1f66d9]"
